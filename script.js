...
para.innerHTML = ' <a src='+jj+' onclick="lanuchapp1('+jj+',this);more()"><img src='+"http://www.google.com/s2/favicons?domain="+host+' ><p>'+" "+gh.getElementsByTagName("p")[0].innerHTML+'</p></a> <button style="font-size:15px;    font-size: 15px;margin-top: -46px;float:right;   background-color:transparent;  width: fit-content;" onclick="this.parentNode.outerHTML=null"><i class="fa fa-trash " ></i></button>';        

var par = document.createElement("div");
  par.innerHTML = '<p> <img><txt></txt><button onclick="refresh(this)">&#x21bb;</button>&nbsp;<button onclick="width(this)">      &#xf1eb;</button>&nbsp;<button onclick="fun1(this)">x</button>	</p> <iframe  ></iframe>';
...
xhttp1.open("GET", "https://cors-anywhere.herokuapp.com/"+input.value, true);
xhttp1.send();
...
list.insertBefore(src12.parentNode, list.childNodes[0]);
    ...
    document.getElementsByClassName("unbody")[0].setAttribute("ondblclick","  this.getElementsByTagName('button')[1].click()")
  document.getElementsByClassName("unbody")[0].setAttribute("id",src);
...
var rt=src12.getElementsByTagName("p")[0].innerHTML;
 var g1 =document.getElementById(src).getElementsByTagName("img")[0].setAttribute("src",m);

		      var g1 =document.getElementById(src).getElementsByTagName("txt")[0].innerHTML=" "+rt+" "+"|" +"  ";


var g=document.getElementById(src);
...
if (g.getElementsByTagName("iframe")[0].hasAttribute("src")) {
  ...
  dragElement1(document.getElementById(src));
    ...
    var newItem = document
      .getElementById(src).removeAttribute("class");
			document
      .getElementById(src).style.zIndex="45";
}
...
function width(x) {
  ...
  x.parentNode.parentElement.style.width = "100%";
  x.parentNode.parentElement.style.height = "100%";
  x.parentNode.parentElement.getElementsByTagName("iframe")[0].style.display=""
} 
...
y.parentNode.parentElement.outerHTML='   <div   class="unbody"><p> <img><txt></txt><button onclick="refresh(this)">&#x21bb;</button>&nbsp;<button onclick="width(this)">      &#xf1eb;</button>&nbsp;<button onclick="fun1(this)">x</button>	</p> <iframe  ></iframe></div>  '
...
function dragElement1(elmnt) {
  ...
  function elementDrag1(e) {
    ...
    pos3 = e.clientX;
    pos4 = e.clientY;
    document.getElementById(elmnt.id).style.width ="40%";
    document.getElementById(elmnt.id).style.height ="0%";
        document.getElementById(elmnt.id).getElementsByTagName("iframe")[0].style.display="none"
    ...
    if (pos3 < 1) {
      ...
      document.getElementById(elmnt.id).style.height ="99%";
    } else if (pos3 > 1400) {
      document.getElementById(elmnt.id).getElementsByTagName("iframe")[0].style.display=""
      document.getElementById(elmnt.id).style.left = "900px";
      document.getElementById(elmnt.id).style.top = "-13px";
      document.getElementById(elmnt.id).style.width ="50%";
      document.getElementById(elmnt.id).style.height ="99%";
    }
    if (pos4 < "7") {
      ...
      document.getElementById(elmnt.id).style.left = "1px";
      document.getElementById(elmnt.id).style.width ="99%";
      document.getElementById(elmnt.id).style.height ="60%";
    }
  }
